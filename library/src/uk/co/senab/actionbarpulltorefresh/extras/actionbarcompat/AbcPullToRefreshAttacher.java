...
public class AbcPullToRefreshAttacher extends uk.co.senab.actionbarpulltorefresh.library.PullToRefreshAttacher {

    private FrameLayout mHeaderViewWrapper;

    public AbcPullToRefreshAttacher(ActionBarActivity activity, Options options,FrameLayout container) {
        super(activity, options,container);
    }
